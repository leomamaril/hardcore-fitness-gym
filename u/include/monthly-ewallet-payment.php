...
if (!isset($_SESSION['user_name']) || !isset($_SESSION['user_lname']) || !isset($_SESSION['user_age']) || !isset($_SESSION['user_contact']) || !isset($_SESSION['user_email'])) {
    die("Session variables are not set. Please log in again." . $_SESSION['user_name'] . $_SESSION['user_lname'] . $_SESSION['user_age'] . $_SESSION['user_contact'] . $_SESSION['user_email']);
}
            ...
            if ($stmt_history) {
                ...
                if ($stmt_history->execute()) {
                    ...
                    echo '<script language="javascript" type="text/javascript">
                          window.location = "monthly_payment.php";
                          </script>';
                } else {
