  ...
  <i class="material-symbols-outlined">
    ...
    <section class="home-section">
        <section class="historyLog">
            <span class="header moul-regular">Visitor's Today</span>
            <table class="table moulpali-regular">
                ...
                <tbody>
                    ...
                    // ===== Fetch Data ===== //
                    $date = date("M-d-Y");
                    $ret = mysqli_query($conn, "SELECT * from visitor WHERE date = '$date'");
                    $cnt = 1;
                    ...
                    while ($row = mysqli_fetch_array($ret)) {
                        ...
                        <tr>
                            ...
                            <td data-label="contact"><?php echo $row['age']; ?></td>
                            <td data-label="email"><?php echo $row['contact']; ?></td>
                            <td data-label="date"><?php echo $row['date']; ?></td>
                            <td data-label="email"><?php echo $row['time']; ?></td>
                        </tr>
                        <?php
                        // ===== Increment Counter ===== //
                        ++$cnt;
