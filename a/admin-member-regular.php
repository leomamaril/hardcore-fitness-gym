        ...
        <ul class="nav-links">
            ...
            <li class="active">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="active"><a href="admin-member-regular.php">Regular Members</a></li>
...
<div class="profile-details">
  ...
  <i class="material-symbols-outlined">
    ...
    <section class="historyLog">
        <span class="header moul-regular">Regular Members</span>
        <table class="table moulpali-regular">
            ...
            <tbody class="align-items-center">
                ...
                $ret = mysqli_query($conn, "SELECT * FROM user WHERE plan_type = 'Regular'");
                $cnt = 1;
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="content">
                            <!-- Edit Form -->
                            <form action="include/update-member.php" method="POST">
                                ...
                                <div class="user-details">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <!-- <input type="email" id="edit-mop" name="email" placeholder="Email" required> -->
